...
\begin{flalign*}
    \braket{+x \; | \; \psi_0} &= \bra{+x} \left( \frac{1}{\sqrt{10}}\ket{+x} - \frac{3}{\sqrt{10}}\ket{-x} \right) \\
                               &= \frac{1}{\sqrt{10}}\braket{+x \; | +x} - \frac{3}{\sqrt{10}}\braket{+x \; | -x} \\
                               &= \frac{1}{\sqrt{10}} \\
\end{flalign*}
...
\begin{flalign*}
    \ket{\psi_1} &= \frac{\braket{+x \; | \; \psi_0}}{\left| \braket{+x \; | \; \psi_0} \right|} \ket{+x} \\
                 &= \frac{1}{\sqrt{10}} \ket{+x} \\
\end{flalign*}