...
\begin{flalign*}
    & \ket{\Psi_2} = \frac{1}{2}(1 + i)\ket{\phi_1} + \frac{1}{2}(1 - i)\ket{\phi_2}
\end{flalign*}
...
\begin{flalign*}
    \ket{\psi_2} &= \sqrt{\frac{2}{5}} \left( i\ket{\phi_2} + \sqrt{\frac{3}{2}}i \ket{\phi_3} \right) = \sqrt{\frac{2}{5}}i\ket{\phi_2} + \sqrt{\frac{3}{5}}i\ket{\phi_3}
\end{flalign*}
...
\begin{flalign*}
    & \braket{\phi_1 | \psi_1} = \bra{\phi_1} \left( a\ket{\phi_1} + b\ket{\phi_2} - \frac{1}{2}\ket{\phi_3} \right) = a = \frac{\sqrt{3}}{2\sqrt{2}}
\end{flalign*}

\begin{flalign*}
    & \braket{\phi_2 | \psi_1} = \bra{\phi_2} \left( a\ket{\phi_1} + b\ket{\phi_2} - \frac{1}{2}\ket{\phi_3} \right) = b = \frac{\sqrt{3}}{2\sqrt{2}}
\end{flalign*}

\begin{flalign*}
    & \braket{\phi_3 | \psi_1} = \bra{\phi_3} \left( a\ket{\phi_1} + b\ket{\phi_2} - \frac{1}{2}\ket{\phi_3} \right) = -\frac{1}{2} \\
\end{flalign*}
...
\begin{flalign*}
    & P(\phi_1) = \left| \braket{\phi_1 | \psi_1} \right|^2 = \frac{3}{8}
\end{flalign*}

\begin{flalign*}
    & P(\phi_2) = \left| \braket{\phi_2 | \psi_1} \right|^2 = \frac{3}{8}
\end{flalign*}

\begin{flalign*}
    & P(\phi_3) = \left| \braket{\phi_3 | \psi_1} \right|^2 = \frac{1}{4} \\
\end{flalign*}
...
\begin{flalign*}
    \braket{\phi_1 | \psi_2} &= \bra{\phi_1} \left( \sqrt{\frac{2}{5}}i\ket{\phi_2} + \sqrt{\frac{3}{5}}i\ket{\phi_3} \right) = 0 \\
    \braket{\phi_2 | \psi_2} &= \bra{\phi_2} \left( \sqrt{\frac{2}{5}}i\ket{\phi_2} + \sqrt{\frac{3}{5}}i\ket{\phi_3} \right) = \sqrt{\frac{2}{5}}i \\
    \braket{\phi_3 | \psi_2} &= \bra{\phi_3} \left( \sqrt{\frac{2}{5}}i\ket{\phi_2} + \sqrt{\frac{3}{5}}i\ket{\phi_3} \right) = \sqrt{\frac{3}{5}}i \\
\end{flalign*}
...
\begin{flalign*}
    P(\phi_1) &= \left| \braket{\phi_1 | \psi_2} \right|^2 = 0 \\
    P(\phi_2) &= \left| \braket{\phi_2 | \psi_2} \right|^2 = \frac{2}{5} \\
    P(\phi_3) &= \left| \braket{\phi_3 | \psi_2} \right|^2 = \frac{3}{5} \\
\end{flalign*}
...
\begin{flalign*}
    & P(\psi_2) = \left| \braket{\psi_2 | \psi_1} \right|^2 \\
\end{flalign*}
...
\begin{flalign*}
    \ket{\psi} &= \sqrt{\frac{3}{5}} \left( \frac{i}{\sqrt{3}}\ket{+z} - \frac{2}{\sqrt{3}}\ket{-z} \right) = \frac{i}{\sqrt{5}}\ket{+z} - \frac{2}{\sqrt{5}}\ket{-z}    
\end{flalign*}
...
\begin{flalign*}
    \braket{\chi | \psi} &= \left( \frac{1}{\sqrt{2}}\ket{+z} + \frac{1}{\sqrt{2}}\ket{-z} \right)^* \left( \frac{i}{\sqrt{5}}\ket{+z} - \frac{2}{\sqrt{5}}\ket{-z} \right) \\
                         &= \frac{i}{\sqrt{10}}\braket{+z | +z} - \frac{2}{\sqrt{10}}\braket{-z | -z} \\
                         &= \frac{i}{\sqrt{10}} - \frac{2}{\sqrt{10}} \\
\end{flalign*}
...
\begin{flalign*}
    & P(\chi) = \left| \braket{\chi | \psi} \right|^2 = \frac{1}{10} + \frac{4}{10} = \frac{1}{2} \\
\end{flalign*}